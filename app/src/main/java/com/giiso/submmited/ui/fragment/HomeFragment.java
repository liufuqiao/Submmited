...
public class HomeFragment extends BaseFragment<MenuPresenter> implements MenuView {
    ...
    private void initViewPager() {
        mFragmentAdapter = new FragmentPagerAdapter(getChildFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                if(position == 0 || position == 43){//任务列表
                    fragment = TaskFragment.newInstance();
                } else if(position == 1 || position == 44){
                    fragment = SubmmitedFragment.newInstance();
                } else if(position == 2 || position == 55){
                    fragment = ExceptionFragment.newInstance();
                }
                return fragment;
            }
