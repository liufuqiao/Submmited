...
/**
 * Created by xingwt on 2015/8/13.
 */
public class SwipeToLoadLayout extends ViewGroup {
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * a switcher indicate whiter load activity_more function is enabled
     */
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * offset to trigger load activity_more
     */
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration status release to loading activity_more -> loading activity_more
     */
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Load activity_more complete delay duration
     */
    private int mLoadMoreCompleteDelayDuration = DEFAULT_LOAD_MORE_COMPLETE_DELAY_DURATION;

    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration status load activity_more complete -> default
    ...
    /**
     * <b>ATTRIBUTE:</b>
     * Scrolling duration status default -> loading activity_more, mainly for auto load activity_more
    ...
    /**
     * is load activity_more function is enabled
     *
     * @return
     */
    ...
    /**
     * is current status loading activity_more
     *
     * @return
     */
    ...
    /**
     * set refresh header iv_view, the iv_view must at lease be an implement of {@code SwipeRefreshTrigger}.
     * the iv_view can also implement {@code SwipeTrigger} for activity_more extension functions
     *
     * @param view
     */
    public void setRefreshHeaderView(View view) {
        if (view instanceof SwipeRefreshTrigger) {
            ...
            Log.e(TAG, "Refresh header iv_view must be an implement of SwipeRefreshTrigger");
        }
    }

    /**
     * set load activity_more footer iv_view, the iv_view must at least be an implement of SwipeLoadTrigger
     * the iv_view can also implement {@code SwipeTrigger} for activity_more extension functions
     *
     * @param view
     */
    public void setLoadMoreFooterView(View view) {
        if (view instanceof SwipeLoadMoreTrigger) {
            ...
            Log.e(TAG, "Load activity_more footer iv_view must be an implement of SwipeLoadTrigger");
        }
    }
    ...
    /**
     * switch load activity_more function on or off
     *
     * @param enable
     */
     ...
     * Default value is the refresh header iv_view height {@link #mHeaderHeight}<p/>
     ...
     * Default value is the load activity_more footer iv_view height {@link #mFooterHeight}<p/>
    ...
    /**
     * Set the final offset you can swipe to load activity_more.<br/>
    ...
    /**
     * set an {@link OnLoadMoreListener} to listening load activity_more event
     *
     * @param listener
     */
    ...
    public void setRefreshing(boolean refreshing) {
        ...
        if (refreshing) {
            // can not perform refresh when it is refreshing or loading activity_more
    ...
    /**
     * auto loading activity_more or cancel
     *
     * @param loadingMore
     */
    public void setLoadingMore(boolean loadingMore) {
        ...
        if (loadingMore) {
            // can not perform load activity_more when it is refreshing or loading activity_more
            if (STATUS.isRefreshing(mStatus)) {
                return;
            }
                    ...
                    public void run() {
                        ...
                        if (mTargetView instanceof AbsListView) {
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                                ((AbsListView) mTargetView).scrollListBy(200);
                            }
                        } else {
                            mTargetView.scrollBy(0, 200);
    ...
    protected void onFinishInflate() {
        ...
        if (childNum == 0) {
            ...
            // activity_more than three children: unsupported!
    ...
    /**
     * check if it can load activity_more
     *
     * @return
     */
     ...
     *
     * @return Whether it is possible for the child iv_view of this layout to
     * scroll up. Override this if the child iv_view is a custom iv_view.
     */
    ...
    /**
     * Whether it is possible for the child iv_view of this layout to
     * scroll down. Override this if the child iv_view is a custom iv_view.
     *
     * @return
     */
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                // if the event pass to the child iv_view while ACTION_MOVE(condition is false)
                ...
                // child iv_view's onTouchEvent. So we must deal this situation in dispatchTouchEvent
                onActivePointerUp();
                break;
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                mLastY = mInitDownY;
                mLastX = mInitDownX;
                // let children iv_view handle the ACTION_DOWN;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (triggerCondition) {
                    // the trigger condition refresh or load activity_more is true
    ...
    private void fingerScroll(final float yDiff) {
        ...
        if (STATUS.isSwipingToRefresh(mStatus) || STATUS.isReleaseToRefresh(mStatus)) {
            ...
            if (yDiff > 0) {
                // load activity_more returning
                ratio = DEFAULT_DRAG_RATIO * 4;
            } else if (yDiff < 0) {
                // swiping to load activity_more
                ratio = DEFAULT_DRAG_RATIO;
            }
            ...
            if (yDiff > 0 && -mTargetOffset <= mLoadMoreTriggerOffset) {
                // loading activity_more + swipe down
                ratio = 0;
            } else if (yDiff < 0) {
                // swiping + swipe up
                ratio = DEFAULT_DRAG_RATIO;
        ...
        // make sure (refresh -> default -> load activity_more) or (load activity_more -> default -> refresh)
        // forbidden fling jump default status (refresh -> load activity_more)
        // I am so smart :)
            ...
            if (STATUS.isRefreshing(mStatus) && mLoading) {
                ...
                if (STATUS.isRefreshComplete(mStatus) || STATUS.isSwipingToRefresh(mStatus)
                    ...
                    mRefreshCallback.onReset();
                        ...
                        //FIX quick scrolling release to load activity_more jump swiping to load activity_more directly lead mTargetOffset > 0 bug
    ...
    /**
     * load activity_more event callback
     */
    ...
    public void setNoMore(boolean noMore) {
        if(mFooterView!=null) {
            ((ClassicLoadMoreFooterView) mFooterView).setNoMore(noMore);
        }
    }
}
