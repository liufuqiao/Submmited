...
public class LoginPresenter extends BasePresenter<LoginView> {
    ...
    public void login(final String username, final String pwd) {
        mView.showLoading();
        addDisposable(apiServer.logins(username, pwd), new BaseObserver<ResultResponse<User>>(mView) {

            @Override
            public void onSuccess(ResultResponse<User> o) {
                mView.closeLoading();
    ...
    public void login_out(){
        mView.showLoading();
        addDisposable(apiServer.logins_out(), new BaseObserver<ResultResponse>(mView) {
