...
public class CustomItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        int dragFlags = 0;
        int swipeFlags = 0;
        if(onItemTouchCallbackListener!=null&&!onItemTouchCallbackListener.isItemLongClick(viewHolder.getLayoutPosition()))
        {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        ...
        switch (actionState) {
            ...
            case ItemTouchHelper.ACTION_STATE_DRAG:
                //开始拖拽
                onItemTouchCallbackListener.onStart(viewHolder, actionState);
                break;
    ...
    public interface OnItemTouchCallbackListener {
        ...
        void onStart(RecyclerView.ViewHolder viewHolder, int actionState);

        boolean isItemLongClick(int index);
    }
}
